 ...
 * 보일러플레이트
 */
class Upload_from_mobile extends ModuleObject
{
	/**
    ...
    protected static $_insert_triggers = [
		...
		[ 'moduleObject.proc', 'after', 'triggerModuleProcAfter' ]
	];
	 ...
	 * 모델 인스턴스를 가져옵니다.
	 *
	 * @return Upload_from_mobileModel
	 */
	protected function getModel(): self
	{
		return Upload_from_mobileModel::getInstance();
	}

	/**
	 * 컨트롤러 인스턴스를 가져옵니다.
	 *
	 * @return Upload_from_mobileController
	 */
	protected function getController(): self
	{
		return Upload_from_mobileController::getInstance();
	}

	/**
	 * 뷰 인스턴스를 가져옵니다.
	 * 
	 * @return Upload_from_mobileView
	 */
	protected function getView(): self
	{
		return Upload_from_mobileView::getInstance();
	}

	/**
	 * 관리자 모델 인스턴스를 가져옵니다.
	 *
	 * @return Upload_from_mobileAdminModel
	 */
	protected function getAdminModel(): self
	{
		return Upload_from_mobileAdminModel::getInstance();
	}

	/**
	 * 관리자 컨트롤러 인스턴스를 가져옵니다.
	 *
	 * @return Upload_from_mobileAdminController
	 */
	protected function getAdminController(): self
	{
		return Upload_from_mobileAdminController::getInstance();
	}

	/**
	 * 관리자 뷰 인스턴스를 가져옵니다.
	 * 
	 * @return Upload_from_mobileAdminView
	 */
	protected function getAdminView(): self
	{
		return Upload_from_mobileAdminView::getInstance();
	}
